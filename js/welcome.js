...
$.ajax({
    ...
    data: {
        key: 'GUXBZ-RCHLQ-DIV54-2MZJ6-XZPES-6YB2A',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(32.59944, 112.45222, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
