...
hexo.extend.filter.register('after_generate',function() {
    if(hexo.config.history_calendar.enable){
        ...
        if(hexo.config.swiper && hexo.config.swiper.enable){
            var css_text =`<link rel="stylesheet" href="https://cdn.jsdmirror.com/gh/Zfour/Butterfly-card-history/baiduhistory/css/main.css">`;
            var js_text =`<script data-pjax src="https://cdn.cbd.int/luoh-blog@0.0.1/js/baiduhistory.js"></script>`

        }else{
            var css_text =`<link rel="stylesheet" href="https://cdn.cbd.int/swiper/swiper-bundle.min.css"><link rel="stylesheet" href="https://cdn.jsdmirror.com/gh/Zfour/Butterfly-card-history/baiduhistory/css/main.css">`;
            var js_text =`<script data-pjax  src="https://cdn.cbd.int/swiper/swiper-bundle.min.js"></script><script data-pjax src="https://cdn.cbd.int/luoh-blog@0.0.1/js/baiduhistory.js"></script>`
